...
penguins |>
  drop_na() |>
  ggplot(
    aes(flipper_length_mm, bill_length_mm, color = species, shape = sex)
  ) +
  geom_point(size = 2.5) +
  geom_smooth(
    aes(group = species),
...
- There are 8 lectures in total, each accompanied by:
  ...
  - [Exercises](#exe) to complete and hand in
...
- May 19: Seminar for the last lecture
  (Note, that this is 1 week later than would be expected
  according to a perfect fit of 2 lectures per week,
  because there are two public holidays (April 21 & May 1) in the timespan that are excluded)
...
To complete the course, hand in at least 7 out of 8 exercises.
...
The earlier you submit your solutions, the more time I have to prepare specific answers to your questions for the seminar.
...
If you are a biochemistry student at Heidelberg University, click on this link: <https://discord.gg/TYQhFAAfxu> to join our discord server to sign up for the course.
